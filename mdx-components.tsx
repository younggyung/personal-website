...
const components = {
  ...
  ol: (props: ListProps) => <ol className="list-decimal space-y-2 pl-5 text-gray-800 dark:text-zinc-300" {...props} />,
  ul: (props: ListProps) => <ul className="list-disc space-y-1 pl-5 text-gray-800 dark:text-zinc-300" {...props} />,
